...
const Header = () => {
  return (
    <div className=' flex w-[100%] items-center justify-between   px-4 py-2'>
      <img className='w-48' src="https://upload.wikimedia.org/wikipedia/commons/0/08/Netflix_2015_logo.svg" alt="logo" />
      <div className='flex items-center'>
      <CircleChevronDown size="24px" color='white'/>
        <h1 className='font-semibold text-lg text-white'>Debjit</h1>
